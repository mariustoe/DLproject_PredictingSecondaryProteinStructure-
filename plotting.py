...
def make_vae_plots(vae, x, y, outputs, training_data, CASP12_data,TS115_data,CB513_data, figsize=(18, 6)):
    ...
    ax.plot(CASP12_data['elbo'], label='CASP12')
    ax.plot(TS115_data['elbo'], label='TS115')
    ax.plot(CB513_data['elbo'], label='CB513')
    ax.legend()
    ...
    ax.plot(CASP12_data['kl'], label='CASP12')
    ax.plot(TS115_data['kl'], label='TS115')
    ax.plot(CB513_data['kl'], label='CB513')
    ax.legend()
    ...
    ax.plot(CASP12_data['log_px'], label='CASP12')
    ax.plot(TS115_data['log_px'], label='TS115')
    ax.plot(CB513_data['log_px'], label='CB513')
    ax.legend()
